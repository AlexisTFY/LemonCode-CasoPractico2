...
exports.getSalesTypeList = exports.getProvinceTypeList = exports.getPropertyList = void 0;
...
var mapPropertyListFromApiToVM = function mapPropertyListFromApiToVM(properties) {
...
Promise.all([(0, _propertyList.getPropertyList)(), (0, _propertyList.getSalesTypeList)(), (0, _propertyList.getProvinceTypeList)()]).then(function (_ref) {
  ...
  (0, _propertyList3.setOptions)(_propertyList4.minPriceOptions, 'select-min-price', 'Min €');
  (0, _propertyList3.setOptions)(_propertyList4.maxPriceOptions, 'select-max-price', 'Max €');
});
