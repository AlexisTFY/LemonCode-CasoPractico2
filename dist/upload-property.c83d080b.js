...
exports.insertProperty = exports.getSalesTypeList = exports.getProvinceTypeList = exports.getEquipments = void 0;
...
var getSalesTypeList = function getSalesTypeList() {
  return _axios.default.get(saleTypeListUrl).then(function (response) {
    return response.data;
  });
};

exports.getSalesTypeList = getSalesTypeList;
var saleProvinceListUrl = "".concat("http://localhost:3000/api", "/provinces");

var getProvinceTypeList = function getProvinceTypeList() {
  return _axios.default.get(saleProvinceListUrl).then(function (response) {
    return response.data;
  });
};

exports.getProvinceTypeList = getProvinceTypeList;
var equipmentstUrl = "".concat("http://localhost:3000/api", "/equipments");

var getEquipments = function getEquipments() {
  return _axios.default.get(equipmentstUrl).then(function (response) {
    return response.data;
  });
};

exports.getEquipments = getEquipments;
var urlProperty = "".concat("http://localhost:3000/api", "/properties");

var insertProperty = function insertProperty(property) {
  return _axios.default.post("".concat(urlProperty, "/").concat(property.id), property).then(function (response) {
    return response.data;
  });
};
...
Promise.all([(0, _uploadProperty2.getSalesTypeList)(), (0, _uploadProperty2.getProvinceTypeList)(), (0, _uploadProperty2.getEquipments)()]).then(function (_ref) {
  ...
  (0, _uploadProperty3.setCheckboxList)(equipments, 'equipments');
});
var generalData = {
  id: '',
  title: '',
...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  generalData = _objectSpread(_objectSpread({}, generalData), {}, {
    title: value
  });

  _uploadProperty.formValidation.validateField('title', generalData.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty.formValidation.validateField('notes', generalData.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty.formValidation.validateField('email', generalData.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty.formValidation.validateField('phone', generalData.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty.formValidation.validateField('price', generalData.price).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty.formValidation.validateField('address', generalData.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadProperty.formValidation.validateField('city', generalData.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty.formValidation.validateField('province', generalData.province).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty.formValidation.validateField('squareMeter', generalData.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty.formValidation.validateField('rooms', generalData.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty.formValidation.validateField('bathrooms', generalData.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty.formValidation.validateField('locationUrl', generalData.locationUrl).then(function (result) {
...
(0, _helpers.onUpdateField)('equipments', function (event) {
  ...
  _uploadProperty.formValidation.validateField('equipments', generalData.equipmentIds).then(function (result) {
...
(0, _helpers.onUpdateField)('saleTypes', function (event) {
  ...
  _uploadProperty.formValidation.validateField('saleTypes', generalData.saleTypes).then(function (result) {
    (0, _helpers.onSetError)('saleTypes', result);
  });
});
var element = document.getElementById('insert-feature-button');

element.onclick = function () {
  var elementToInsert = document.getElementById('newFeature').value;
  (0, _uploadProperty3.onAddFeature)(elementToInsert);
  generalData.mainFeatures.push(elementToInsert);
  var elementToDelete = document.getElementById("delete-".concat(elementToInsert, "-button"));

  elementToDelete.onclick = function () {
    (0, _uploadProperty3.onRemoveFeature)(elementToInsert);
    removeItemFromArr(generalData.mainFeatures, elementToInsert);
  };

  _uploadProperty.formValidation.validateField('newFeature', generalData.mainFeatures).then(function (result) {
    (0, _helpers.onSetError)('newFeature', result);
  });
};

var removeItemFromArr = function removeItemFromArr(arr, item) {
...
(0, _helpers.onAddFile)('add-image', function (value) {
  (0, _uploadProperty3.onAddImage)(value);
  generalData.images.push(value);
});
(0, _helpers.onSubmitForm)('save-button', function () {
  _uploadProperty.formValidation.validateForm(generalData).then(function (result) {
