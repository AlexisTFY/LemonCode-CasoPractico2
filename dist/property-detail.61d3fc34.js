...
exports.sendContact = exports.getProperty = exports.getEquipments = void 0;
...
var sendContact = function sendContact(contactForm) {
  return _axios.default.post(urlContact, contactForm).then(function (response) {
    return response.data;
  });
};
...
exports.mapPropertyDetailFromApiToVM = void 0;
...
var mapEquipments = function mapEquipments(property, equipments) {
  console.log(property);
  console.log(equipments);
  var map = property.equipmentIds.map(function (obj) {
    var find2 = equipments.find(function (element) {
...
Promise.all([(0, _propertyDetail.getProperty)(params.id), (0, _propertyDetail.getEquipments)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      property = _ref2[0],
      equipments = _ref2[1];

  var propertyDetail = property[0];
  (0, _propertyDetail2.setPropertyValues)((0, _propertyDetail3.mapPropertyDetailFromApiToVM)(propertyDetail, equipments));
});
var contactForm = {
  email: '',
  message: ''
